...
GetHandler::GetHandler(KVstorage *storage) : storage(storage) {
}
...
PutHandler::PutHandler(KVstorage *storage) : storage(storage) {
}
...
DeleteHandler::DeleteHandler(KVstorage *storage) : storage(storage) {
}
...
StatHandler::StatHandler(KVstorage *storage) : storage(storage) {
}
...
HandlerFactory::HandlerFactory(KVstorage *storage) : storage(storage) {
}
